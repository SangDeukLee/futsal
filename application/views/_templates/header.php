...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/public/assets/css/ihover.css">
	...
	<link href="/public/assets/css/ground.css" rel="stylesheet">
	...
	<script src="/public/assets/js/ownTeam_shot.js"></script>
	<script src="/public/assets/js/reply_more.js"></script>
	<script src="/public/assets/js/homeground.js"></script>
	<script src="/public/assets/js/reply_write.js"></script>
	<script src="/public/assets/js/reply_delete.js"></script>
	<script src="/public/assets/js/reply_update.js"></script>
...
<!-- <body onload="document.body.scrollTop=document.cookie, init(this.form);" onunload="document.cookie=document.body.scrollTop"> -->
...
<script>
	...
	socket.on( 'receiver_messages', function( data ) {
		// alert('sdfsd');
		console.log('skldfjsdkljfklsdjkl');
		if((<?php echo "'$_SESSION[loginID]'"; ?> == data.receiver)){
			if(data.open_check){
				window.open('/chat.php/' + data.receiver + '/' + data.name,'second','width=500,height=700,toolbar=0,scrollbars=0,resizable=0');
			}
		}
	});
	...
	socket.on('note', function(data){
		...
		{	// alert(data.current_number);
			// console.log('sdkljf');
			$("#note").html(data.current_number);
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<button id="message" type="button" class="btn btn-primary" data-dismiss="modal" onclick="" >
					<span class="glyphicon glyphicon-envelope" aria-hidden="true"></span>  Message
				</button>

				<button id="chat" type="button" class="btn btn-primary" data-dismiss="modal" onclick="" >
					<span class="glyphicon glyphicon-comment" aria-hidden="true"></span>  Chat
				</button>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="team-modal-title" id="teamModalLabel" align="center">

				</h4>
			</div>

			<div id="team-modal-body" class="modal-body" align="center">

			</div>
			<!--<script>
				var sessionID = <?php /*echo $_SESSION['loginID']; */?>
			...
			<div class="modal-footer">
				...
				<button type="button" id="bookmarkT" class="btn btn-primary" >
					<span id="checkT" class="starT" aria-hidden="true"></span>즐겨찾기
				</button>


				<button id="homeShot_team" type="button" class="btn btn-primary" data-dismiss="modal">
					<span class="glyphicon glyphicon-home" aria-hidden="true"></span>  home
				</button>
...
<!-- 소속팀 상세보기 -->
<div class="modal fade" id="ownTeamModal" tabindex="-1" role="dialog" aria-labelledby="ownTeamModalLabel" aria-hidden="true" >
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span>
				...
				<h4 class="modal-title" id="ownTeamModalLabel" align="center">
			...
			<div class="modal-footer">
				...
				<button id="homeShot_ownTeam" type="button" class="btn btn-primary" data-dismiss="modal">
					<span class="glyphicon glyphicon-home" aria-hidden="true"></span>  home
				</button>
	...
	<header class="header black-bg">
		...
		<div class="nav notify-row" id="top_menu">
			...
			<ul class="nav top-menu">
				...
				<li class="dropdown">
					<a  href="/Message">
						...
						<?php
							$num = $number->aa;
							if($num != 0){
								echo "<span id='note' class='badge bg-theme'>";
								echo $num;
								echo "</span>";
							}
							else {
				...
				<li id="header_inbox_bar" class="dropdown">
					<a href="/member/modifyv">
						<i class="glyphicon glyphicon-user">정보수정</i>
					</a>
