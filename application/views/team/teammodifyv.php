        ...
        <div class="col-lg-9 main-chart">
            ...
            <div class="team_page">
                <table border="1" width="600">
                    <form name="form" action="/team/teammodify" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="team_home[]" value="<?= $team_home[0] ?>">
                        <input type="hidden" name="team_home[]" value="<?= $team_home[1] ?>">
                        ...
                        <input type="hidden" name="team_psimage" value="<?php echo $team_page->team_psimage ?>">
                        <tr>
                            <td rowspan="4">
                                <img id="Uploadedimg"
                                     src="/public/img/team/<?php echo $team_page->team_pfimage ?>" width="133" height="133">
                                <input type="file" name="pfimage" onchange="readURL(this);">
                            </td>
                            <td><?php echo $team_page->team_name ?></td>
                            <td rowspan="4">

                                <input type="submit" name="teamModify" value="팀 수정">
