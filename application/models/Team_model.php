...
class Team_model extends CI_Model
{
    ...
    function getTeamList($user_id)
    {
        ...
        $this->db->from('team t');
        $this->db->join('attach_team a', 'a.team_name = t.team_name');
    ...
    function getTeamBoardList($team_name){
        return $this->db->get_where('teampage', array('team_name' => $team_name))->result();
    }
    ...
    function makeTeamCheck($team_name)
    {
    ...
    function  kickout($user_id,$attach_team_num){
        $this->db->delete('attach_team',array('user_id' => $user_id, 'attach_team_num' => $attach_team_num));
    }

    function findteamname($attach_team_num){
        $this->db->select('team_name');
        $this->db->where('attach_team_num', $attach_team_num);
        $query = $this->db->get("attach_team");
        return $query->row();
    }
    function teamdelete($team_name){
        $this->db->delete('team',array('team_name' => $team_name));
    }
}
