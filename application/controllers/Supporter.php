...
class Supporter extends CI_Controller
{
    ...
    public function getList() // 용병 리스트를 출력
    {
        ...
        $supporter['supporter_getList'] = $this -> Supporter_model -> getListSupporterBoard($last_num, $limit);

        if($is_loading) {
            $supporter['supporter_getList'] = $this -> Supporter_model ->getListSupporterBoard_Scroll($last_num, $limit);
    ...
    public function write() // 글쓰기
    {
        ...
        if (isset($_POST["submit_write_supporter"])) {
            ...
            $this -> Supporter_model->writeSupporterBoard($spt_writer, $spt_date, $spt_starttime, $spt_endtime, $spt_number, $spt_content, $spt_address);
        }
    ...
    public function view($spt_num) // 용병글 자세히 보기
    {
        ...
        $supporter['supporter_writer_and_board'] = $this -> Supporter_model ->viewSupporterBoardInfo($spt_num);
        $supporter['supporter_team'] = $this -> Supporter_model ->viewSupporterBoardTeamInfo($spt_num);
        $supporter['supporter_request'] = $this -> Supporter_model ->viewSupporterBoardRequestInfo($spt_num);
    ...
    public function request() // 용병 신청
    {
        ...
        $supporter_request = $this -> Supporter_model -> requestSupporterBoard($spt_num, $user_id, $request_num);
    ...
    public function gameJoin($user_id, $spt_num, $sptr_number) // 신청 승인
    {
        ...
        $supporter_model = $this -> Supporter_model;
    ...
    public function modify($spt_num) // 용병글 수정
    {
        ...
        if (isset($_POST["submit_modify_supporter"])) {
            ...
            $this -> Supporter_model -> modifySurpporterBoard($spt_num, $spt_date, $spt_starttime, $spt_endtime, $spt_number, $spt_content, $spt_address);
